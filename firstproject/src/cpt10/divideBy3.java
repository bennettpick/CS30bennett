 ...
 * Title: Divide By 3 
Purpose:
To design a graphical user interface that prompts a user to eneter
a number they wish to divide by three. The code will then run the number 
and tell the user if it is divisible by three or not. If it is, the GUI
will tell the user that it is divisible by three along with the answer.
If the number is not the GUI wil tell this to the user along with the
answer as a decimal.
 */
package cpt10;
